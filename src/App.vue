...
import SecurityChart from './components/Dashboard/SecurityChart.vue';
import AttackLogs from './components/Dashboard/AttackLogs.vue';
import AddWebsiteModal from './components/UI/AddWebsiteModal.vue';
import SecurityDetailsModal from './components/UI/SecurityDetailsModal.vue';
...
const allAttacks = computed(() => {
  return websites.value
    .flatMap(website => website.attacks)
